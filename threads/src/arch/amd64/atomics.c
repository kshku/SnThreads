                ...
                switch (sizeof(type)) {                                                                         \
                    ...
                    case 2:                                                                                     \
                        return (type)SN_GET_ATOMIC_FUNCTION(compare_exchange, int16_t)(                         \
                            (SN_GET_ATOMIC_TYPE(int16_t) *)obj, (int16_t *)expect, (int16_t)value,              \
                            success, fail);                                                                     \
                    case 4:                                                                                     \
                        return (type)SN_GET_ATOMIC_FUNCTION(compare_exchange, int32_t)(                         \
                            (SN_GET_ATOMIC_TYPE(int32_t) *)obj, (int32_t *)expect, (int32_t)value,              \
                            success, fail);                                                                     \
                    case 8:                                                                                     \
                        return (type)SN_GET_ATOMIC_FUNCTION(compare_exchange, int64_t)(                         \
                            (SN_GET_ATOMIC_TYPE(int64_t) *)obj, (int64_t *)expect, (int64_t)value,              \
                            success, fail);                                                                     \
                    default:                                                                                    \
                        return (type)0;                                                                         \
                }                                                                                               \
                ...
                switch (sizeof(type)) {                                                            \
                    case 1:                                                                        \
                        return (type)SN_GET_ATOMIC_FUNCTION(compare_exchange, uint8_t)(            \
                            (SN_GET_ATOMIC_TYPE(uint8_t) *)obj, (uint8_t *)expect, (uint8_t)value, \
                            success, fail);                                                        \
                    case 2:                                                                        \
