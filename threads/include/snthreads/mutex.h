 ...
 */
SN_THREADS_API void sn_mutex_init(SnMutex *m);
 ...
 * @param m Pointer to mutex.
 */
SN_THREADS_API void sn_mutex_deinit(SnMutex *m);
 ...
 * @param m Pointer to mutex.
 */
SN_THREADS_API void sn_mutex_lock(SnMutex *m);
 ...
 */
SN_THREADS_API bool sn_mutex_try_lock(SnMutex *m);
 ...
 */
SN_THREADS_API void sn_mutex_unlock(SnMutex *m);
