 ...
 */
SN_THREADS_API void sn_memory_fence(SnMemoryOrder fence);
 ...
 * @param memory_order The memory order to use
 */
SN_THREADS_API void sn_atomic_flag_clear_explicit(volatile sn_atomic_flag *obj, SnMemoryOrder memory_order);
 ...
 */
SN_THREADS_API bool sn_atomic_flag_load_explicit(volatile sn_atomic_flag *obj, SnMemoryOrder memory_order);
